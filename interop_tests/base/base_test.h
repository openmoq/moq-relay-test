...
template<typename T>
void BaseTest::assertEqual(const T& expected, const T& actual, const std::string& message) {
    if (expected != actual) {
...
template<typename T>
void BaseTest::assertNotEqual(const T& expected, const T& actual, const std::string& message) {
    if (expected == actual) {
